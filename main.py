...
# Set the path for Tesseract executable (Windows-only)
...
class OCRApp:
    ...
    def process_frame(self, image):
        ...
        # Get orientation and script detection data from Tesseract
        osd = pytesseract.image_to_osd(threshold_img)
        print("Orientation and Script Detection:", osd)

        # Extract angle of rotation from the OSD data
        angle = int(osd.split('\n')[0].split(':')[1].strip())
        ...
        # Perform OCR after possible rotation
